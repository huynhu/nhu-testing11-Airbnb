...
- generic [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e315]:
      - generic [ref=e316]:
        - generic [ref=e317]:
          - heading "Giới thiệu" [level=2] [ref=e318]
          - list [ref=e319]:
            - listitem [ref=e320]:
              - link "Phương thức hoạt động của Cyber" [ref=e321] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e322]:
              - link "Trang tin tức" [ref=e323] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e324]:
              - link "Nhà đầu tư" [ref=e325] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e326]:
              - link "Cyber Plus" [ref=e327] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e328]:
              - link "Cyber Luxe" [ref=e329] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e330]:
              - link "HotelTonight" [ref=e331] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e332]:
              - link "Cyber for Work" [ref=e333] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e334]:
              - link "Nhờ có Host, mọi điều đều có thể" [ref=e335] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e336]:
              - link "Cơ hội nghề nghiệp" [ref=e337] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e338]:
              - link "Thư của nhà sáng lập" [ref=e339] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
        - generic [ref=e340]:
          - heading "Cộng đồng" [level=2] [ref=e341]
          - list [ref=e342]:
            - listitem [ref=e343]:
              - link "Sự đa đạng và Cảm giác thân thuộc" [ref=e344] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e345]:
              - link "Tiện nghi phù hợp cho người khuyết tật" [ref=e346] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e347]:
              - link "Đối tác liên kết Cyber" [ref=e348] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e349]:
              - link "Chỗ ở cho tuyến đầu" [ref=e350] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e351]:
              - link "Lượt giới thiệu của khách" [ref=e352] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e353]:
              - link "CyberSoft.edu.vn" [ref=e354] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
        - generic [ref=e355]:
          - heading "Đón tiếp khách" [level=2] [ref=e356]
          - list [ref=e357]:
            - listitem [ref=e358]:
              - link "Cho thuê nhà" [ref=e359] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e360]:
              - link "Tổ chức Trải nghiệm trực tuyến" [ref=e361] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e362]:
              - link "Tổ chức Trải nghiệm" [ref=e363] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e364]:
              - link "Đón tiếp khách có trách nhiệm" [ref=e365] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e366]:
              - link "Trung tâm tài nguyên" [ref=e367] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e368]:
              - link "Trung tâm cộng đồng" [ref=e369] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
        - generic [ref=e370]:
          - heading "Hỗ trợ" [level=2] [ref=e371]
          - list [ref=e372]:
            - listitem [ref=e373]:
              - link "Biện pháp ứng phó đại dịch COVID-19" [ref=e374] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e375]:
              - link "Trung tâm trợ giúp" [ref=e376] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e377]:
              - link "Các tùy chọn hủy" [ref=e378] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e379]:
              - link "Hỗ trợ khu dân cư" [ref=e380] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
            - listitem [ref=e381]:
              - link "Tin cây và an toàn" [ref=e382] [cursor=pointer]:
                - /url: https://cybersoft.edu.vn
      - generic [ref=e384]:
        - generic [ref=e385]: © 2022 Nguyễn Nhật Sang, Inc.Quyền riêng tư.Điều khoản.Sơ đồ trang web.
        - generic [ref=e386]:
          - img [ref=e388]
          - text: Tiếng Việt (VN)
          - text: USD
          - generic [ref=e390]: Hỗ trợ tài nguyên
  - generic [ref=e391]:
    - dialog "Chỉnh sửa hồ sơ":
      - generic [ref=e392]:
        - button "Close" [ref=e393] [cursor=pointer]:
          - img "close" [ref=e395]:
            - img [ref=e396]
        - generic [ref=e399]: Chỉnh sửa hồ sơ
        - generic [ref=e404]:
          - generic [ref=e407]:
            - generic "Email" [ref=e409]: "* Email"
            - generic [ref=e413]:
              - textbox "vidu@gmail.com" [ref=e414]: henry@yopmail.com
              - button "close-circle" [ref=e416] [cursor=pointer]:
                - img "close-circle" [ref=e417]:
                  - img [ref=e418]
          - generic [ref=e422]:
            - generic "Họ tên" [ref=e424]:
              - text: "* Họ tên"
              - img "question-circle" [ref=e425]:
                - img [ref=e426]
            - generic [ref=e432]:
              - textbox "* Họ tên question-circle" [ref=e433]:
                - /placeholder: Nguyễn Văn A
                - text: Henry Ba Khiem
              - button "close-circle" [ref=e435] [cursor=pointer]:
                - img "close-circle" [ref=e436]:
                  - img [ref=e437]
          - generic [ref=e441]:
            - generic "Số điện thoại" [ref=e443]: "* Số điện thoại"
            - generic [ref=e444]:
              - generic [ref=e447]:
                - textbox "* Số điện thoại" [ref=e448]:
                  - /placeholder: 0903 123 123
                  - text: "1234567890"
                - button "close-circle" [ref=e450] [cursor=pointer]:
                  - img "close-circle" [ref=e451]:
                    - img [ref=e452]
              - alert [ref=e455]:
                - generic [ref=e456]: Sai định dạng số điện thoại!
          - generic [ref=e459]:
            - generic "Ngày sinh" [ref=e461]: "* Ngày sinh"
            - generic [ref=e466]:
              - textbox "* Ngày sinh" [ref=e467]:
                - /placeholder: Chọn ngày sinh
                - text: 21/04/2026
              - generic:
                - img "calendar":
                  - img
              - button "close-circle" [ref=e468] [cursor=pointer]:
                - img "close-circle" [ref=e469]:
                  - img [ref=e470]
          - generic [ref=e474]:
            - generic "Giới tính" [ref=e476]: "* Giới tính"
            - generic [ref=e480] [cursor=pointer]:
              - generic [ref=e481]:
                - combobox "* Giới tính" [ref=e483]
                - generic "Nữ" [ref=e484]
              - generic:
                - img:
                  - img
              - img [ref=e486]:
                - img [ref=e487]
        - button "Cập nhật" [active] [ref=e492] [cursor=pointer]:
          - generic [ref=e493]: Cập nhật
```